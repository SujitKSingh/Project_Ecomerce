		...
		<div class="row">
			...
			<div class="col-md-9 col-sm-8">
				<form method="post" id="contactform" name="contactform"
					class="contact-form clearfix" action="mail/contact.php">
					<div class="row">
						<div class="col-md-5">
							...
							<div class="form-group">
								<input id="lname" name="Last Name" class="form-control input-lg"
							...
							<div class="form-group">
								<input id="phone" name="phone" class="form-control input-lg"
						...
						<div class="col-md-7">
							...
							<input id="submit" name="submit"
								class="btn btn-primary btn-lg  site-btn pull-right"
